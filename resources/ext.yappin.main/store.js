...
const store = reactive( {
	...
	isEditing: null,
	// Whether the current user can moderate other people's comments. This variable is set
	// when a new list of comments is retrieved from the database via the API call.
	isMod: false,
